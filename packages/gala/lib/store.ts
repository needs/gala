...
export type Stage = { name: string, timeline: Record<string, TimelineRotation | TimelinePause>, timelineStartDate: string, progress?: number, apparatuses: Partial<Record<ApparatusKey, number>> };
...
export function stageRotations(stage: Stage): (TimelineRotation | TimelinePause)[] {
